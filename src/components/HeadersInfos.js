    ...
    return (
        <div className="header-container">
            ...
            <ul className="infos-mkt">
                ...
                <li>BTC Dominance : {headerData.market_cap_percentage &&
                    headerData.market_cap_percentage.btc.toFixed(1) + "%"}</li>
